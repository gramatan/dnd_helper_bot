...
HELP_MESSAGE = (
    ...
    "🎲 Бросок характеристик персонажа: используйте команду /roll\\_stats (или /roll\\_stats N для повторения N раз). "
    "Эта команда бросает четыре кубика d6 для каждой из шести характеристик персонажа, убирая наименьший результат "
    "в каждом броске и суммируя оставшиеся. При нескольких попытках выбирается набор с наибольшей суммой характеристик.\n\n"
    ...
    '🆕🙏 Молитва создателю: если у вас есть предложения, замечания или просто благодарность, '
    'вы можете использовать команду /feedback, чтобы напрямую отправить сообщение создателю бота.\n\n'
